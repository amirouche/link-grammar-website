  ...
  (sxml->html `(html
                ...
                (body
                 ...
                 (div (@ (id "container"))
                      (div (@ (id "main"))
                           (div (@ (id "header"))
                                (h1 (a (@ (href ,ROOT)) "Link Grammar")))
                           (ul (@ (id "navigation"))
                               (li (a (@ (href ,(string-append ROOT "/documentation.html"))) "Documentation"))
                               (li (a (@ (href ,(string-append ROOT "/changelog.html"))) "ChangeLog"))
                               (li (a (@ (href "http://www.abisource.com/downloads/link-grammar/")) "Download"))
                               (li (a (@ (href "https://github.com/opencog/link-grammar")) "Forge"))
                               (li (a (@ (href "http://groups.google.com/group/link-grammar?hl=en")) "Help")))
                           (div (@ (id "content"))
                                ,(commonmark->sxml (read-string)))))))))
